...
; CHECK: G_STORE %2(s32), %5(p0) :: (store (s32), align 1)
; CHECK: %8:_(s32) = G_CONSTANT i32 2
; CHECK: %7:_(p0) = nuw inbounds G_PTR_ADD %0, %8(s32)
; CHECK: G_STORE %3(s32), %7(p0) :: (store (s32), align 1)
; CHECK: %10:_(s32) = G_CONSTANT i32 3
; CHECK: %9:_(p0) = nuw inbounds G_PTR_ADD %0, %10(s32)
; CHECK: G_STORE %4(s32), %9(p0) :: (store (s32), align 1)
