...
; CHECK: G_STORE %1(s32), %0(p0) :: (store (s32), align 1)
; CHECK: %7:_(s32) = G_CONSTANT i32 1
; CHECK: %6:_(p0) = nuw inbounds G_PTR_ADD %0, %7(s32)
; CHECK: G_STORE %2(s32), %6(p0) :: (store (s32), align 1)
; CHECK: %9:_(s32) = G_CONSTANT i32 2
; CHECK: %8:_(p0) = nuw inbounds G_PTR_ADD %0, %9(s32)
; CHECK: G_STORE %3(s32), %8(p0) :: (store (s32), align 1)
